  ...
  <table>
    <tr>
      ...
      <td id="curling-io__summary" data-widgets-location="<?php echo $curling_io_widgets_api; ?>">
        ...
        <input type="text" readonly="readonly" length="24" value="[<?php echo CURLING_IO_SHORTCODE; ?>]" />

        <h4>Legacy Short Code</h4>
        <input type="text" readonly="readonly" length="24" value="[<?php echo CURLING_IO_SHORTCODE_LEGACY; ?>]" />
