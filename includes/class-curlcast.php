...
class Curlcast {
   ...
   * @since    1.0.0
   * @access   protected
   * @var      Curlcast_Loader    $loader    Maintains and registers all hooks for the plugin.
   */
  protected $loader;
   ...
   *
   * - Curlcast_Loader. Orchestrates the hooks of the plugin.
   * - Curlcast_i18n. Defines internationalization functionality.
   * - Curlcast_Admin. Defines all hooks for the admin area.
   * - Curlcast_Public. Defines all hooks for the public side of the site.
   *
   ...
   *
   * Uses the Curlcast_i18n class in order to set the domain and to register the hook
   * with WordPress.
   *
   * @since    1.0.0
   * @access   private
   ...
   *
   * @since     1.0.0
   * @return    Curlcast_Loader    Orchestrates the hooks of the plugin.
   */
